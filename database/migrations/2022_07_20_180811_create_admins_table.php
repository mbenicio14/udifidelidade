...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('admins', function (Blueprint $table) {
            ...
            // Account information
            $table->tinyInteger('role')->default(2)->index()->comment('1 = Admin, 2 = Manager');
            ...
            $table->foreignId('created_by')->nullable()->constrained('admins')->cascadeOnDelete()->index()->name('fk_admins_created_by');
            $table->foreignId('deleted_by')->nullable()->constrained('admins')->cascadeOnDelete()->index()->name('fk_admins_deleted_by');
            $table->foreignId('updated_by')->nullable()->constrained('admins')->nullOnDelete()->index()->name('fk_admins_updated_by');
            $table->softDeletes();
            $table->timestamps();
        });
    }
