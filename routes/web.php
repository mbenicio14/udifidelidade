...
Route::prefix('{locale}')->group(function () {
    ...
    Route::post('/whatsapp/request-code', 'Auth\WhatsAppAuthController@requestCode')->name('whatsapp.request-code');
    Route::post('/whatsapp/verify-code', 'Auth\WhatsAppAuthController@verifyCode')->name('whatsapp.verify-code');
    Route::post('/whatsapp/update-profile', 'Auth\WhatsAppAuthController@updateProfile')
        ->middleware('auth:member')
        ->name('whatsapp.update-profile');

    Route::post('/login', 'Auth\WhatsAppAuthController@login')->name('login.post');
    Route::post('/register', 'Auth\WhatsAppAuthController@register')->name('register.post');
    ...
    Route::group(['middleware' => 'installed', 'namespace' => '\App\Http\Controllers'], function () {
        ...
        Route::group(['middleware' => ['member.auth', 'member.role:1,2,3']], function () {
            ...
            // Redeem generated code
            Route::get('redeem-code', [\App\Http\Controllers\Member\CodeController::class, 'showRedeemCode'])->name('member.code.redeem');
            Route::post('redeem-code', [\App\Http\Controllers\Member\CodeController::class, 'postRedeemCode'])->name('member.code.redeem.post');
