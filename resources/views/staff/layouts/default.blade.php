                    ...
                    <div class="grid py-4 px-4 mx-auto max-w-screen-2xl lg:grid-cols-2 md:px-6">
                        <div class="flex items-center">
                            <ul class="flex flex-row items-center mt-0 space-x-8 text-sm font-medium">
                                ...
                                <li>
                                    <a href="{{ route('staff.data.list', ['name' => 'cards']) }}" class="hover:text-black dark:hover:text-white @if ($routeDataDefinition == 'cards') text-gray-900 dark:text-white @else text-gray-700 dark:text-gray-400 @endif">{{ trans('common.loyalty_cards') }}</a>
                                </li>
                                <li>
                                    <a href="{{ route('staff.data.list', ['name' => 'codes']) }}" class="hover:text-black dark:hover:text-white @if ($routeDataDefinition == 'codes') text-gray-900 dark:text-white @else text-gray-700 dark:text-gray-400 @endif">{{ trans('common.redemption_codes') }}</a>
                                </li>
<?php /*
                                <li>
...
<?php /*
                        ...
                        <li @if ($routeDataDefinition == 'cards') class="active" @endif>
                            <a href="{{ route('staff.data.list', ['name' => 'cards']) }}"><x-ui.icon icon="qr-card" class="w-6 h-6" /><span>{{ trans('common.loyalty_cards') }}</span></a>
                        </li>
                        <li @if ($routeDataDefinition == 'codes') class="active" @endif>
                            <a href="{{ route('staff.data.list', ['name' => 'codes']) }}"><x-ui.icon icon="coins" class="w-6 h-6" /><span>{{ trans('common.redemption_codes') }}</span></a>
                        </li>
